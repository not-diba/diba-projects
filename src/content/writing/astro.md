...
That’s where Astro’s concept of **_partial hydration_** comes in.

![Islands Architecture: Jason Miller.](/writing/islands.avif)
...
With partial hydration, **_Astro only hydrates the interactive parts_** of your page — the “islands” — and leaves the rest as static HTML. This means you get the interactivity you want without sacrificing performance.

_(I'll probably write more about this topic another time.)_
...
The idea behind components is to break your code into smaller, reusable pieces — making your project easier to build and maintain. Astro fully supports this pattern, and you can pass data between components using **_props_**, just like in other frontend frameworks.
